document.getElementById('user_first_name').addEventListener('blur', user_first_name);
document.getElementById('user_last_name').addEventListener('blur', user_last_name);
document.getElementById('user_email').addEventListener('blur', user_email);
document.getElementById('user_phone').addEventListener('blur', user_phone);
document.getElementById('user_name').addEventListener('blur', user_name);
document.getElementById('user_password').addEventListener('blur', user_password);
document.getElementById('user_confirm_password').addEventListener('blur', user_confirm_password);
document.getElementById('work_order_type').addEventListener('blur', work_order_type);
document.getElementById('ticket_site_id').addEventListener('blur', ticket_site_id);
document.getElementById('ticket_po_number').addEventListener('blur', ticket_po_number);
document.getElementById('hours_to_add').addEventListener('blur', hours_to_add);
document.getElementById('engineer_first_name').addEventListener('blur', engineer_first_name);
document.getElementById('engineer_last_name').addEventListener('blur', engineer_last_name);
document.getElementById('engineer_email').addEventListener('blur', engineer_email);
document.getElementById('engineer_address').addEventListener('blur', engineer_address);
document.getElementById('engineer_phone').addEventListener('blur', engineer_phone);
document.getElementById('customer_name').addEventListener('blur', customer_name);
document.getElementById('customer_product').addEventListener('blur', customer_product);
document.getElementById('customer_address').addEventListener('blur', customer_address);
document.getElementById('customer_phone').addEventListener('blur', customer_phone);
document.getElementById('customer_email').addEventListener('blur', customer_email);
document.getElementById('work_order_type_edit').addEventListener('blur', work_order_type_edit);
document.getElementById('user_first_name_edit').addEventListener('blur', user_first_name_edit);
document.getElementById('user_last_name_edit').addEventListener('blur', user_last_name_edit);
document.getElementById('user_email_edit').addEventListener('blur', user_email_edit);
document.getElementById('user_address_edit').addEventListener('blur', user_address_edit);
document.getElementById('user_phone_edit').addEventListener('blur', user_phone_edit);
document.getElementById('user_name_edit').addEventListener('blur', user_name_edit);
document.getElementById('user_password_edit').addEventListener('blur', user_password_edit);
document.getElementById('user_confirm_password_edit').addEventListener('blur', user_confirm_password_edit);
document.getElementById('hours_to_add_edit').addEventListener('blur', hours_to_add_edit);
document.getElementById('engineer_first_name_edit').addEventListener('blur', engineer_first_name_edit);
document.getElementById('engineer_last_name_edit').addEventListener('blur', engineer_last_name_edit);
document.getElementById('engineer_email_edit').addEventListener('blur', engineer_email_edit);
document.getElementById('engineer_address_edit').addEventListener('blur', engineer_address_edit);
document.getElementById('engineer_phone_edit').addEventListener('blur', engineer_phone_edit);
document.getElementById('customer_name_edit').addEventListener('blur', customer_name_edit);
document.getElementById('customer_product_edit').addEventListener('blur', customer_product_edit);
document.getElementById('customer_address_edit').addEventListener('blur', customer_address_edit);
document.getElementById('customer_phone_edit').addEventListener('blur', customer_phone_edit);
document.getElementById('customer_email_edit').addEventListener('blur', customer_email_edit);
...
function engineer_last_name() {
    ...
    if (!re_engineer_last_name.test(engineer_last_name.value)) {
        return engineer_last_name.classList.add('is-invalid');
    } else {
        return engineer_last_name.classList.remove('is-invalid');
    }
